...
RSpec.describe "User views an order show page" do
  ...
  it "changes order status from pending to packaged when all order items are fulfilled" do
    ...
    order.item_orders.create!(item: @paper, price: @paper.price, quantity: 10, fulfill_status: "fulfilled")
    order.item_orders.create!(item: @pencil, price: @pencil.price, quantity: 3, fulfill_status: "fulfilled")
    order.item_orders.create!(item: @tire, price: @tire.price, quantity: 2, fulfill_status: "fulfilled")
